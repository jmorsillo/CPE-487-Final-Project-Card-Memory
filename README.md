...
- Some general extra modifications we'd include if we had the time to implement them would be the use of a keypad instead of buttons, and a randomizer to randomize the location of the cards
