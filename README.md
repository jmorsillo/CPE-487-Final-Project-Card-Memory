...
https://github.com/user-attachments/assets/81ce9624-4e44-4ec4-a059-b9b5777baacd


- The reset

https://github.com/user-attachments/assets/434c481d-3c54-4193-b8e1-693e650e6bd3
...
### Conclusion
- This project proposed many problems related to timing and the clock signal which presents some bugs in our code like the timings so we added phases and added a phase indicator
- The project was created by Joseph Morsillo and Gabriel Culha and was mostly collaborative with both people helping with everything
- Joseph Morsillo was responsible for most of the vga_top file and the card_memory file as well as project hierarchy management
- Gabriel Culha was responsible for most of the card file and the game logic and card creation
